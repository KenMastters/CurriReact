...
const About = () => {
  return (
    <section className="about">
      <h2>Sobre mí</h2>
      <p>
      Soy un desarrollador web junior titulado en Desarrollo de Aplicaciones Web por I.E.S Francisco de Goya.
        ...
        Estoy especialmente interesado en seguir aprendiendo y profundizando en tecnologías como JavaScript, React, PHP, WordPress y otras que el entorno profesional requiera. 
